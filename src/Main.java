public class Main {
    public static void main(String[] args) {
        ...
        Book masterAndMargarita2 = new Book("Мастер и Маргарита", bulgakov, 1953);


        System.out.println(onegin);
        System.out.println(masterAndMargarita);
        System.out.println("1-е сравнение книг: " + masterAndMargarita.equals(masterAndMargarita2));

        masterAndMargarita.setYearOfPublication(1959);
        System.out.println(masterAndMargarita);

        System.out.println("2-е сравнение книг: " + masterAndMargarita.equals(masterAndMargarita2));
